$(document).ready(function() {
    ...
    $('.navigation').append('<area shape="poly" coords="147,-5, 219,40, 219,120, 147,160, 74,120, 74,40" href="#!/page_Love" alt="" class="nav1">')
    ...
    // $('.map_back').append('<area shape="poly" coords="73,-5, 145,40, 145,120, 73,160, 0,120, 0,40" href="#" alt="" id="back">')
    ...
    $('.navigation area').hover(function() {
        ...
        if (n == 'logo') {
            ...
            $('#nav' + n + '> div').stop(true, true).animate({
                height: 'show'
            }, function() {})
        }
    }, function() {
        ...
        if (n == 'logo') {
            ...
            $('#nav' + n + '> div').stop(true, true).delay(200).animate({
                height: 'hide'
            }, function() {})
        }
    })
    ...
    $('#icons a').hover(function() {
        $(this).find('.img_act').stop().animate({
            opacity: 1
        })
    }, function() {
        $(this).find('.img_act').stop().animate({
...
$(window).load(function() {
    ...
    content.tabs({
        actFu: function(_) {
            if (_.prev && _.curr) {
                fl_cont = false;
                _.prev.find('.pad').stop().animate({
                    opacity: 0
                }, function() {
                    $(this).css({
                        display: 'none'
                    });
                    _.prev.find('.back').stop().animate({
                        opacity: 0
                    }, function() {
                        $(this).css({
                            top: 212,
    ...
    nav.navs(function(n, _) {
        ...
        switch (n) {
          case "#!/page_Love":
            // bg_music.attr("src","music/b.mp3");
             bg_music.src="music/jkzzj/周三 - 一个歌手的情书 (Live).mp3";
          break;
          case "#!/page_About":
            bg_music.src="music/jkzzj/阿肆 _ 林宥嘉 - 致姗姗来迟的你.mp3";
          break;
          case "#!/page_Talk":
            bg_music.src="music/jkzzj/马良 - 往后余生 (Demo).mp3";
          break;
          case "#!/page_Message":
            bg_music.src="music/jkzzj/赵雷 - 开往北京的火车.mp3";
          break;
          case "#!/page_Blog":
            bg_music.src="music/jkzzj/莫文蔚 - 慢慢喜欢你.mp3";
          break;
          case "#!/page_Time":
            bg_music.src="music/jkzzj/赵雷 - 成都.mp3";
          break;
          case "#!/":
            bg_music.src="music/jkzzj/陈芳语 - 爱你 (铃声).mp3";
          break;
          default :
            bg_music.src="music/jkzzj/陈芳语 - 爱你 (铃声).mp3";
            break;
